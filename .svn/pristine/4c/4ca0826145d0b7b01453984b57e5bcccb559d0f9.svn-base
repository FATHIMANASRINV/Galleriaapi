  ...
  // small stat chart
	...
	elmList.map(function(elm) {
		...
		if (chartType == 'bar') {
			...
			chartColors = ['rgba('+ app.color.themeRgb + ', .85)', 'rgba('+ app.color.themeRgb + ', .85)', 'rgba('+ app.color.themeRgb + ', .85)'];
			chartData = [randomNo(), randomNo(), randomNo()];
		} else if (chartType == 'donut') {
			chartColors = ['rgba('+ app.color.themeRgb + ', .85)', 'rgba('+ app.color.themeRgb + ', .85)', 'rgba('+ app.color.themeRgb + ', .85)', 'rgba('+ app.color.themeRgb + ', .85)', 'rgba('+ app.color.themeRgb + ', .85)'];
