                    ...
                    <div class="card-sigin">
                        ...
                        <div class="card-sigin">
                            <div class="main-signup-header">
                                <h5 class="mb-0">{lang('forgot_password')}</h5><small>{lang('enter_mail')}</small>
                                 {form_open('', 'class="form form-horizontal form-simple needs-validation" novalidate=""')}
                                <div class="mt-4">
                                      <div class="mb-3">
                                    <div class="form-group ">
                                        <div class="controls position-relative">
                                        <input type="text" class="form-control" id="user-name" name="user_name" placeholder="{lang('username')}" required autocomplete="off" required="">
                                    <span class="position-absolute top-0 pt-10px end-0 p-2 fs--1" ><a class="text-800" href="{base_url('forgot-username')}">{lang('forgot_username')}</a></span>
                                   ...
                                   <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="forgot" value="forgot">{lang('send_reset_link')}</button>
</div>
                              {form_close()}
                                <div class="main-signin-footer mt-5">
                                    <p class="mb-1"><a href="{base_url('login')}">&larr;{lang('button_back')}</a></p>
