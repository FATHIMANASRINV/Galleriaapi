...
<div class="card"> 
	<div class="card-body ">		
		...
		<div class="col-md-12">		
			<div class="form-group">
				<div class="controls">
					...
					<textarea cols="100" rows="50" class="tinymce d-none" name="content" name="content" required>{$single_details.content}</textarea>
				</div>
		...
		<div class="col-12">
			<button type="submit" class="btn btn-primary" name="update" value="update" id="update">{lang('update')}</button>
		</div>
