...
<div class="card">
	<div class="card-body text-center py-5">
		...
		<h3 class="mt-3 fw-normal fs-2 mt-md-4 fs-md-3">{lang('invite_friend')}</h3>
		...
		<div class="row justify-content-center">
			<div class="col-11 col-sm-10">
				...
				<div class="row gx-2 my-4">
					...
					<div class="col-lg-4">
						<button class="btn btn-falcon-default d-block w-100 ms-0 mb-xl-0"><span class="fab fa-facebook-square text-facebook" data-fa-transform="grow-2"></span><span class="fw-medium ms-2"><a href="http://www.facebook.com/sharer.php?" target="_blank">{lang('share_on_facebook')}</a></span></button>
					</div>
				</div>
				<p class="mb-2 fs--1">{lang('once_you_invited')}<a href="#!">{lang('view_the_status')}</a><br class="d-none d-lg-block d-xxl-none" />{lang('or_visit')} <a href="https://neomlmsoftware.com/contact/">{lang('help_center')}</a>{lang('if_you_have_any_questions')} </p>
			</div>
		</div>
	</div>
</div>
