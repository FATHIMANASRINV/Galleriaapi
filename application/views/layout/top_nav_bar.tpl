    ...
    <div class="brand">
        <a href="{base_url()}" class="brand-logo">
                   {*  <span class="brand-img">
                    ...
                    <img src="{assets_url()}images/logo/{$site_details['logo']}" alt="Profile" height="60">
                </a>
            </div>
            <div class="menu">
                ...
                <div class="menu-item dropdown dropdown-mobile-full">
                    <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link" style="margin-right: -134px;">
                        <div class="menu-img online">
                            <img src="{assets_url()}backend/img/user/profile.jpg" alt="Profile" height="60">
                        </div>
                        <div class="menu-text d-sm-block d-none w-170px">{log_user_name()}</div>
                    </a>
